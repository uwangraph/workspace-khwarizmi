...
<div class="flex flex-col gap-3 my-1">
  <div class="relative group">
    ...
    <div class="flex items-center gap-2.5 overflow-x-auto no-scrollbar pb-1 scroll-smooth">
      <div class="flex items-center gap-2.5 animate-peek">
        <div class="flex items-center gap-2 flex-shrink-0 bg-white border-2 border-b-[4px] border-slate-200 rounded-2xl px-4 py-2 shadow-sm hover:border-slate-300 transition-all cursor-pointer">
          ...
          <select 
            ...
            class="bg-transparent text-xs font-black text-slate-700 outline-none cursor-pointer appearance-none uppercase tracking-tight"
          >
            {#each FILTERS as f}
        ...
        {#if activeFilter !== 'all' || activePriority !== 'all' || sortBy !== 'newest' || search}
          <button 
            ...
            class="flex items-center gap-1.5 bg-orange-50 text-orange-600 border-2 border-b-[4px] border-orange-200 rounded-2xl px-4 py-2 text-xs font-black hover:bg-orange-100 transition-all cursor-pointer flex-shrink-0 shadow-sm active:translate-y-0.5"
          >
